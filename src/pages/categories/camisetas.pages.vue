  ...
  <div class="wj-home">
      ...
      <div class="wj-home__body">
          <div class="wj-home__filter">
              ...
              <p class="wj-home__filter--category" @click="getProducts(2,'unset','unset'),buttonFilter=!buttonFilter" >Camisetas</p>
             <!--  <p class="wj-home__filter--category" @click="getProducts(3,'unset','unset')">Sapatos</p> -->
              ...
              <div>
                ...
                <div class="wj-home__filter--color" @click="getProducts(null,'Amarela','cor'),buttonFilter=!buttonFilter">Laranja</div>
                <div class="wj-home__filter--color">Verde</div>
              </div>
...
export default {
    ...
    methods:{
        getProducts(value, filterValue, typeFilter){
            ...
            //validate args for t-shirt
            if(value == 2 && filterValue == 'unset' && typeFilter == 'unset'){
               this.relatedName = 'Camisetas'
           ...
           //validate args for Color
            if(typeFilter == 'cor'){
                ...
                for(var i = 1; i<=3;i++){
                    if(i != 2 && i!=3){ // This, select the right t-shirt
                        axios.get(this.url+i) 
                            ...
                            this.products = []; //clear the array products
