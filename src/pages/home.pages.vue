  ...
  <div class="wj-home">
      ...
      <div class="wj-home__body">
          <div class="wj-home__filter">
              ...
              <p class="wj-home__filter--category" @click="getProducts(3,'unset','unset')">Sapatos</p>
              <p class="wj-home__filter--category">Acessórios</p>

              <h3 class="wj-home__filter--subtitle">Cores</h3>
              <div>
                   <div class="wj-home__filter--color" @click="getProducts(null,'Vermelha','cor')">vermelho</div>
              <div class="wj-home__filter--color" @click="getProducts(null,'Laranja','cor')">Laranja</div>
              <div class="wj-home__filter--color" @click="getProducts(null,'Azul','cor')">Verde</div>
              </div>
             

              <h3 class="wj-home__filter--subtitle">Tipo</h3>
              <p class="wj-home__filter--type" @click="getProducts(null,'Corrida','tipo')">Corrida</p>
              <p class="wj-home__filter--type" @click="getProducts(null,'Corrida','tipo')">Caminhada</p>
              <p class="wj-home__filter--type" @click="getProducts(null,'Casual','tipo')">Casual</p>
...
export default {
    ...
    data(){
        return{
            ...
            noFilter:3,
            buttonFilter:false,
            relatedName:'Página Inicial',
            page:'Página Inicial'

        }
    },
    created(){
        this.getProducts(this.noFilter);
    },
    methods:{
